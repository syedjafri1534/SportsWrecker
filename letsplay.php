  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-12 f-layer mt-3">
        <h1 class="mt-3 text-center text-primary"><b>Fill Up The Necessary Fields</b></h1>
        <div class="main-box1 bg-light pl-5">
          <div class="row">
              <div class="col-md-7">
                  <form class="letsplay">
                    <label class="mt-5">Select the type of game</label>
                    ...
                    <label class="mt-3">Select the Ground where you want to play</label>
                    <select class="form-control mt-2" id="ddl_ground" name="admin_status">
                        <option value="">-- Select the Ground</option>
                        <option value="ground 1">ground 1</option>
                        <option value="ground 2">ground 2<option>
                        <optio value="ground 3">ground 3</option>
                    </select>
                    <label class="mt-3">Select the Ground where you want to play</label><br>
                    <input type="date" id="dt_date" class="mt-2 mb-3" name="date" >
                    <input type="time" id="dt_time" class="" name="date" ><br>
                    <label class="mt-3 mr-2" >First Name</label>
                    ...
                    <label class="mt-4 mr-2" >Team Name</label>
                    <input type="Text" class="" id="txt_team_name" name="date" placeholder="Karachi King"><br>
                    <label class="mt-4  mr-2" >Captain Name</label>
                    <input type="Text" class="" id="txt_captain" name="date" placeholder="John"><br>
                    <label class="mt-4  mr-2">Player required</label>
                    <input type="Text" class="" name="date" placeholder="No. of player"><br>
                  </form>
              </div>
              <div class="col-md-5">
                  <div class="container-fluid">
                    <div class="row mt-5 mr-3" >
                        ...
                        <div class="detail">
                            ...
                            <div><p class="pl-3"><b>Ground Name</b><span class="side pr-3" id="lbl_ground"></span></p></div>
                            <div><p class="pl-3"><b>Date & Time</b><span class="side pr-3" id="lbl_date"></span><span class="side pr-2 pl-2">-</span><span class="side " id="lbl_time"></span></p></div>
                            ...
                            <div><p class="pl-3"><b>Team Name</b><span class="side pr-3" id="lbl_team_name"></span></p></div>
                            <div><p class="pl-3"><b>Captain Name</b><span class="side pr-3" id="lbl_captain"></span></p></div>
                        </div>
                        <div class="info mt-4">
          ...
          <div class="row">
              <div class="col-md-12 d-flex justify-content-center letsplaybtn">
                   <a href=""><button class="btn btn-primary mt-4 mb-4">Publish</button></a>
              </div>
          </div>
        </div>
      </div>
