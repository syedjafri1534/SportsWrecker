    ...
    <div class="modal-dialog mt-5 " role="document">
      <div class="modal-content ">
				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-md-12 summary">
							<h3>Academy Detail</h3>
						</div>
						<div class="detail">
							<div><p class="pl-3 mt-3">Academy Name<span class="side pr-3">XLR8 Indoor Academy</span></p></div>
							<div><p class="pl-3">Courses In<span class="side pr-3">Cricket</span></p></div>
							<div><p class="pl-3">beginning Of Classes<span class="side pr-3">12-12-2022</span></p></div>
							...
							<div><p class="pl-3">Monthly Fees<span class="side pr-3">8000 Rs</span></div>
						</div>
					</div>
				</div>		
			</div>
        ...
        <div class="modal-footer modal-body-letsplay">
          ...
          <a href="academy_info.php"><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal">
        Proceed
      </button></a>
        </div>
      </div>
...
<div class="container-fluid">
	<div class="row">
		<div class="col-md-12 tournament academy p-0 m-0">
			<img src="./images/academy-bannner.jpg" class="mt-3">
			<h2 class="text-center text-dark">Enroll on Your Own</h2>
		</div>
	</div>
</div>
...
<div class="container-fluid">
	<div class="row">
		<div class="col-md-3">
			<div class="img-card2">
				<img src="images/sectionimage1.jpg">
				<h4>XLR8 Indoor Academy</h4>
				<button class="btn cardbtn1">Football Ground</button>
				<h6>Karachi</h6>
				<a href="#"><button type="button" class="btn cardbtn2" data-toggle="modal" data-target="#exampleModalLong">Enroll Now</button></a>
			</div>	
		</div>
		<div class="col-md-3">
			<div class="img-card2">
				...
				<button class="btn cardbtn1">Football Ground</button>
				<h6>Karachi</h6>
				<button class="btn cardbtn2">Enroll Now</button>
			</div>	
		</div>
		<div class="col-md-3">
			<div class="img-card2">
